...
const pages: readonly CmsPageRecord[] = [
  ...
  { id: "contact", eyebrow: "Call or message", title: "Contact Siriranee in Howth", description: "Find us at Harbour House or ask about an appointment.", seoTitle: "Contact Siriranee Thai Massage | Howth, Dublin", seoDescription: "Contact Siriranee Thai Massage in Howth, Dublin. Find our Harbour House address, phone number, provisional hours, directions and booking page.", version: 2, updatedAt: seededAt },
  { id: "visit", eyebrow: "Plan your journey", title: "Find Us in Howth", description: "View our address, opening hours and directions.", seoTitle: "Visit Siriranee Thai Massage in Howth, Dublin", seoDescription: "Visit Siriranee Thai Massage on Floor 3 of Harbour House, Harbour Road, Howth. View hours, directions and nearby Dublin areas served.", version: 2, updatedAt: seededAt },
  ...
  { id: "promotions", eyebrow: "Treat someone", title: "Massage Gifts & Offers", description: "See confirmed options, then contact us to arrange one.", seoTitle: "Massage Gift Ideas & Offers in Howth, Dublin", seoDescription: "Explore massage gift ideas and current appointment options from Siriranee Thai Massage in Howth, Dublin.", version: 2, updatedAt: seededAt },
